...
public class RobotPlayer {
	private static final int MAX_SOLDIERS = 200;
	...
	private static int encampmentTypeCounter;
	...
	public static void run(RobotController myRC) {
		...
		if (enemyHQ == null) { 
			...
			encampmentTypeCounter = 0;
			try {
				neutralEncampmentSquares = rc.senseEncampmentSquares(homeHQ, 50, Team.NEUTRAL);
